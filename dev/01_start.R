...
golem::fill_desc(
  ...
  pkg_title = "Energy Data Analytics Dashboard - Student Version",
  # The Title of the package containing the App
  pkg_description = "A data analytics dashboard concieved for building energy data. This project is built on top of golem infrastructure and distributed as package. ",
  # The Description of the package containing the App
  author_first_name = "Roberto",
  # Your First Name
  author_last_name = "Chiosa",
  # Your Last Name
...
usethis::use_mit_license(copyright_holder = "Roberto Chiosa")  # You can set another license here
